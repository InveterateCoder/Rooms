...
export class Room extends Component {
    ...
    formMessage = (msg, today) => {
        ...
        let time = `${isToday ? todaytext[this.context.lang] : `${date.getFullYear()}-${date.getMonth()}-${date.getDate()}`}, ${date.getHours()}:${date.getMinutes()}`;
    ...
    render() {
        return <div id="room">
            <div id="roomcont" className="container-fluid">
                ...
                <input id="input" type="text" className="form-control" placeholder={placeholder[this.context.lang]} />
    ...
    componentDidMount() {
        let today = new Date();
        this.msgpanel.current.appendChild(this.formMessage(fakeMsgs[0], today))
